...
Приложение позволяет пользователю следить за своим питанием и подсчитывать потребляемое число каллорий.  
