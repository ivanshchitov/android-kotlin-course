...
По окончанию раунда приложение отображает текущую статистику по раунду: отгаданные и неотгаданные слова, количество набранных баллов; а также возможность передать ход следующей команде.  
