...
На главном экране приложения пользователь может запустить один из существующих таймеров. После старта таймера на главном окне показывается: сколько времени прошло после старта таймера. После нажатия на кнопку «остановить текущий таймер» выполняется остановка таймера и пользователю предлагается ввести краткую информацию о проделанных действиях.
